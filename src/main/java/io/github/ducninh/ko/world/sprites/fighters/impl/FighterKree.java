package io.github.ducninh.ko.world.sprites.fighters.impl;

import com.jogamp.newt.event.KeyEvent;
import io.github.ducninh.ko.world.sprites.fighters.power.impl.PowerupKree;
...
import io.github.ducninh.ko.resources.ImageResource;
...
public class FighterKree extends AbstractFighter {
    ...
    public void update() {
        ...
        if(KeyEventListener.isRegisteredKey(KeyEvent.VK_H)) {
